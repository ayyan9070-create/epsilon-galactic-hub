...
export default function About() {
  ...
  return (
    <div className="about-page text-white overflow-hidden">
      ...
      {/* ========================================================= */}
      {/*  HTML CONTENT SECTION (from your uploaded HTML file)      */}
      {/* ========================================================= */}
      ...
      {/* WHAT TO EXPECT */}
      <section className="relative w-full py-24 px-6 animate-scroll-fade-up">
        <div className="max-w-[1300px] mx-auto text-center">
          <img src="/img/epsi-badge.svg" className="mx-auto" />
          <h2 className="font-clash-display text-6xl text-gradient">WHAT TO EXPECT</h2>
      ...
      {/* MODULES SECTION */}
      <section className="relative py-24 overflow-hidden animate-scroll-fade-up">
        <img
        ...
        <div className="relative max-w-[1300px] mx-auto px-6">
          ...
          {/* If you want, I can also fully convert your marquee modules */}
        </div>
      </section>

      {/* ========================================================= */}
      {/*  REACT CONTENT SECTION (your lucide-react version)        */}
      {/* ========================================================= */}
      ...
      <div className="container mx-auto px-4 py-20">
        ...
        {/* WHAT TO EXPECT COUNTERS */}
        <div className="mb-20">
          <h2 className="text-4xl md:text-5xl font-bold text-center mb-16 text-glow tracking-wider">
            WHAT TO EXPECT
          </h2>
